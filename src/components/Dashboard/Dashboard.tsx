    ...
    <div className="container-dashboar">
      ...
      <div className="balkanai-info">
        ...
        <p>
          ...
          košta 400 dinara ili 4€ zavisno od načina plaćanja. Mesečna pretplata
          se mora obnavljati manuelno - ne postoji opcija automatske obnove ili
          produžetka.
        </p>
        <p>
        ...
        <p>
          ...
          tokena možete se pretplatiti ponovo. Ukoliko ne potrošite svih 20.000
          tokena u roku od 30 dana vaši tokeni se brišu, dakle, nisu prenosivi
          iz meseca u mesec.
        </p>
      ...
      <div className="balkanai-info">
        ...
        <p>
          1. Uplatom preko Nnetbanking-a, Mbanking-a & fizičkom uplatom iz banke
          ili pošte <br /> 2. Putem PayPal-a
        </p>
        <p>
          Korisnicima iz Srbije se preporučuje prvi način, dok se korisnicima iz
          Hrvatske, Crne Gore, Makedonije i Bosne preporučuje drugi način.
        </p>
        <p>
          Prilikom pretplate putem PayPal-a u opis transakcije navesti EMAIL sa
          kojim se logujete na Balkan AI kako bismo mogli da identifikujemo
          uplatu te Vam dodelimo tokene
        </p>
      </div>
      <div className="images-dashboard">
        <img src={uplatnica1} width="65%" alt="uplatnica" />
        <div className="pp">
          <img src={pplogo} alt="" />
          <button type="button" onClick={() => navigate("/paypal")}>
